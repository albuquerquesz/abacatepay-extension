...
export function LoginScreen({ onLogin }: LoginScreenProps) {
	...
	return (
		<div className="flex flex-col items-center justify-center h-screen w-full bg-vscode-bg text-vscode-fg p-6 animate-fade-in border-r border-vscode-subtle-border">
